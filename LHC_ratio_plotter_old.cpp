...
int main() {
  ...
  numerator_filename = main_dir + "/output/diff_LHC_T_sigma_W_c_bk_Pb_diffraction.txt"; // "data/diff_LHC_T_sigma_W_c_bk_Pb_diffraction.txt";
  denominator_filename = main_dir + "/output/J_LHC_T_inclusive_c_bk_Pb.txt"; // "data/J_LHC_T_inclusive_c_bk_Pb.txt";
