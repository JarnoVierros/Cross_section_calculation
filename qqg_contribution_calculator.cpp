...
//cout << "rQ_s: " << rQ_s << endl;
//cout << "x: " << x << endl;
//cout << "log arg: " << const_beta*rQ_s << endl;
...
double Ig_integrand(double r, void * parameters) {
  ...
  double N = no_b_dipamp(c*r, xpom);
  double value = r*gsl_sf_bessel_Jn(2, a*r)*gsl_sf_bessel_Kn(2, b*r)*(2*N-N*N);
