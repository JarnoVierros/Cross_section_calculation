...
void generate_p_interpolator_arguments(array<array<array<array<array<double, 5>, 81>, 30>, 30>, 30> &table, vector<vector<double>::iterator> &grid_iter_list, array<int, 4> &grid_sizes, vector<double> &N_vec, int &num_elements) {
    ...
    num_elements = grid_sizes[0]*grid_sizes[1]*grid_sizes[2]*grid_sizes[3];
